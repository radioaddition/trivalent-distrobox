...
curl https://copr.fedorainfracloud.org/coprs/secureblue/trivalent/repo/fedora-$(rpm -E %fedora)/secureblue-trivalent-fedora-$(rpm -E %fedora).repo -o /etc/yum.repos.d/secureblue-trivalent-fedora-$(rpm -E %fedora).repo
